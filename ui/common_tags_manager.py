...
from PyQt5.QtWidgets import (QDialog, QVBoxLayout, QHBoxLayout, QListWidget,                              QLineEdit, QPushButton, QLabel, QListWidgetItem,                              QMessageBox, QAbstractItemView, QSpinBox, QCheckBox, QWidget, QGraphicsDropShadowEffect)
...
class CommonTagsManager(QDialog):
    ...
    def _init_ui(self):
        ...
        self.btn_close.move(self.width() - 32 - 12, 12)
